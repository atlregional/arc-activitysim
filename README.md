...
## Visualization with SimWrapper

ARC's ActivitySim implementation includes a visualization feature with [SimWrapper](https://activitysim.github.io/activitysim/v1.3.1/users-guide/visualization.html#install-and-run-simwrapper), 
a browser-based interactive visualization software. SimWrapper is installed as 
part of ActivitySim. It pulls from summary tables generated by the "summarize" module
as part of the ActivitySim run. To run SimWrapper, in an activated ActivitySim Python 
environment, navigate to [“output\summarize” folder](https://github.com/atlregional/arc-activitysim/tree/main/output/summarize) 
within the ActivitySim directory, and run the following command:
